...
{
    [[InstaApi sharedClient] GET:path parameters:params
                                success:^(NSURLSessionDataTask *operation, id responseObject) {
                                    ...
                                    for (NSDictionary* obj in data) {
                                        InstaApiTags* tags = [[InstaApiTags alloc] initWithAttributes:obj andPagination:pdata];
